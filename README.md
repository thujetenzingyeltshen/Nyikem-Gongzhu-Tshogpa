...
- Admin panel to manage announcements
...
- Data is stored in browser localStorage for easy offline usage.
- Replace demo admin credentials in `app.js` before production deployment.
